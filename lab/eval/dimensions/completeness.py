"""Completeness dimension: Does SKILL.md cover all required patterns?"""
...
def score(content: str, dimension: EvalDimension, skill_path: str = "", plugin_root: str = "") -> DimensionResult:
    ...
    return DimensionResult.from_assertions("completeness", assertions)
